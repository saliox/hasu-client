...
package io.github.solclient.client.mod.impl.packetapi;
...
import io.github.solclient.client.mod.impl.packetapi.action.ApiAction;
...
public final class PacketApiMod extends StandardMod {
	...
	public void receive(CustomPayloadS2CPacket payload) {
		...
		try {
			...
			logger.warn("An Azur Client API usage error has occured. This is most likely an issue with the server.",
					error);
