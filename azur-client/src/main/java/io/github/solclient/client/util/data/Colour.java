...
public class Colour {
	...
	// Bleu d'accent aligné sur le logo Azur (badge : #008AE8)
	public static final Colour BLUE = new Colour(0, 138, 232);
	public static final Colour BLUE_HOVER = new Colour(40, 170, 255);
